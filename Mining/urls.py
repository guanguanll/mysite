...
urlpatterns = [
    ...
    path('drilling_design_params/', worker_views.drilling_design_params, name="drilling_design_params"),
    ...
    # 给钻孔施工数据列表刷新数据
    path('construct_list_data/', worker_views.construct_list_data, name='construct_list_data'),
    # 跳转到施工数据填报表单
    path('goto_drill_construct_layer_page/', worker_views.goto_drill_construct_layer_page, name='goto_drill_construct_layer_page'),

    # 跳转到冲孔申请页面
    # path('flush_apply/', worker_views.flush_apply, name='flush_apply'),
    # 跳转到冲孔数据list页面
    ...
    # 跳转到冲孔申请页面
    path('flush_apply_index/', worker_views.flush_apply_index, name='flush_apply_index'),
    #跳转到封控申请界面
    path('feng_apply_index/', worker_views.feng_apply_index, name='feng_apply_index'),
    ...
    # 操作员查看钻孔施工监控视list
    path('check_videos_record_list/', operator_views.check_videos_record_list, name='check_videos_record_list'),
    # 操作员查看钻孔施工监控视list的渲染
    path('check_videos_record_rendering/', operator_views.check_videos_record_rendering, name='check_videos_record_rendering'),
    # 操作员查看钻孔施工监控视list的填充
    path('check_videos_record_fillin/', operator_views.check_videos_record_fillin, name='check_videos_record_fillin'),
    # 视屏监控数据提交
    path('videos_data_submit_process/', operator_views.videos_data_submit_process, name="videos_data_submit_process"),


    # 操作员查看视频举牌记录的list视图
    path('check_videos_holding_record/', operator_views.check_videos_holding_record, name='check_videos_holding_record_list'),
    path('check_videos_holding_record_list/', operator_views.check_videos_holding_record_list, name='check_videos_holding_record_list'),
    # 操作员查看视频举牌记录list的数据渲染视图
    path('check_videos_holding_record_rendering/', operator_views.check_videos_holding_record_rendering, name='check_videos_holding_record_rendering'),
    # 操作员查看视频举牌记录的数据填充视图
    path('check_videos_holding_record_fillin/', operator_views.check_videos_holding_record_fillin, name='check_videos_holding_record_fillin'),
    # 举牌记录填报
    path('videos_juipai_submit_process/', operator_views.videos_juipai_submit_process, name="videos_juipai_submit_process"),


    # 操作员查看施工资料记录的list
    path('check_material_record_list/', operator_views.check_material_record_list, name='check_material_record_list'),
    # 操作员查看施工资料记录list的渲染
    path('check_material_record_rendering/', operator_views.check_material_record_rendering, name='check_material_record_rendering'),
    # 操作员查看施工资料记录list的填充
    path('check_material_record_fillin/', operator_views.check_material_record_fillin, name='check_material_record_fillin'),
    # 施工资料验收界面
